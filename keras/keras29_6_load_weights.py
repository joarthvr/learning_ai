...
# model.save_weights(PATH_SAVE + 'keras29_5_save_weights1.weights.h5')
# model.load_weights(PATH_SAVE + 'keras29_5_save_weights1.weights.h5') 초기 가중치
model.load_weights(PATH_SAVE + 'keras29_5_save_weights2.weights.h5')
model.summary()
