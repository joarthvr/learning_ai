...
print(x_train.shape, y_train.shape)  # (464809, 54, 1, 1) (464809, 7)
print(x_test.shape, y_test.shape)  # (116203, 54, 1, 1) (116203, 7)
# ======================================================================
...
model.add(MaxPool2D(POOL))  # 54 -> 27
...
======================= 실험 기록 =======================
===== RESULT ===== cpu
| subject=covtype | device=CPU | seed=42 | units=256-128-64 | act=relu | do=0.2-0.2-0.2 | ts=0.8 | vs=0.15 | bs=2048 | ep=30 | lr=0.001
|| acc=0.8966 | time=56.8s | 1893.1ms/epoch |
===================================
===== RESULT ===== gpu
| subject=covtype | device=GPU | seed=42 | units=256-128-64 | act=relu | do=0.2-0.2-0.2 | ts=0.8 | vs=0.15 | bs=2048 | ep=30 | lr=0.001
|| acc=0.8933 | time=36.6s | 1218.5ms/epoch |
===================================
