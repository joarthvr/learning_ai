...
# target 이 90:10 이라 acc 만으로는 판단 불가 -> AUC 병행
...
======================= 실험 기록 =======================
===== RESULT ===== cpu
| subject=santander | device=CPU | seed=42 | units=64-32-16 | act=relu | do=0.2-0.2-0.2 | ts=0.8 | vs=0.15 | bs=1024 | ep=50 | lr=0.001
|| acc=0.9054 | auc=0.8337 | time=31.1s | 622.2ms/epoch |
===================================
===== RESULT ===== gpu
| subject=santander | device=GPU | seed=42 | units=64-32-16 | act=relu | do=0.2-0.2-0.2 | ts=0.8 | vs=0.15 | bs=1024 | ep=50 | lr=0.001
|| acc=0.9054 | auc=0.8308 | time=28.4s | 568.3ms/epoch |
===================================
| subject=santander | seed=42 | units=64-32-16 | act=relu | do=0.2-0.2-0.2 | ts=0.8 | vs=0.15 | bs=1024 | ep=50 | lr=0.001 ]
|| acc=0.9009 | auc=0.7513 | time=230.2s | 4604.4ms/epoch |
"""
