...
y_train = np.array(ohe.fit_transform(y_train.reshape(-1, 1)))
y_test = np.array(ohe.transform(y_test.reshape(-1, 1)))  # test 는 transform 만!
...
| step=mnist_functional | seed=42 | bs=128 | ep=50
|| acc=0.9918 | loss=0.0296 | time=158.2s |
